<%@ Page Title="" Language="C#" MasterPageFile="~/Main2.Master" AutoEventWireup="true" CodeBehind="pdelete.aspx.cs" Inherits="onlineshoppingfinal.pdelete" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" DataKeyNames="PRODUCTID" DataSourceID="SqlDataSource2"  AutoGenerateDeleteButton="True">
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT * FROM &quot;PRODUCT&quot;" DeleteCommand="DELETE FROM &quot;PRODUCTs&quot; WHERE &quot;PRODUCTID&quot; = :PRODUCTID"></asp:SqlDataSource>
